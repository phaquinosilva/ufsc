...
#define NANVIX_PM_H_
	 ...
	 */
	/**@{*/
	// altered to be used with lottery scheduler
	#define PRIO_IO             80 	/**< Waiting for block operation. */ /* default: -100 */
	#define PRIO_BUFFER        	70   /**< Waiting for buffer.          */ /* default:  -80 */
	#define PRIO_INODE         	60	/**< Waiting for inode.           */ /* default:  -60 */
	#define PRIO_SUPERBLOCK     50	/**< Waiting for super block.     */ /* default:  -40 */
	#define PRIO_REGION         40	/**< Waiting for memory region.   */ /* default:  -20 */
	#define PRIO_TTY            30	/**< Waiting for terminal I/O.    */ /* default:    0 */
	#define PRIO_SIG            20	/**< Waiting for signal.          */ /* default:   20 */
	#define PRIO_USER           10	/**< User priority.               */ /* default:   40 */
	/**@}*/
	...
	struct process
	{
		...
		int base_units;			 /**< Process base units	  */
