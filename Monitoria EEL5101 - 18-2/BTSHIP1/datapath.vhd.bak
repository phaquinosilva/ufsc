...
begin
	...
	DEC6: decod_hexa port map (level, display_level);
	letter_U <= "1000001"; --U
	letter_L <= "1000111"; --L
	letter_T <= "0000111"; --t
	letter_R <= "0101111"; --r
	...
	show_user <= "0001" when user='0' else "0010";
	level <= "00"&sel_4x1 + 1;
	select_winner <= (not win1_s) and (not user and win2_s);
	show_winner <= "0001" when select_winner='0' else "0010";
